// Assembles the two browser simulations from the editable .mjs sources so the pages work offline.
...
const strip=inline('model.mjs'),sheet=inline('sheet.mjs'),full=inline('full-model.mjs').replace(/stripModel\(/g,'simulate('),node=inline('node-model.mjs');
